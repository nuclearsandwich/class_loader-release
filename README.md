## class_loader (crystal) - 1.2.0-8

The packages in the `class_loader` repository were released into the `crystal` distro by running `/home/steven/osrf/venv.py2.bloom/bin/bloom-release -r crystal class_loader --override-release-repository-url git@github.com:nuclearsandwich/class_loader-release` on `Wed, 10 Apr 2019 19:34:45 -0000`
...
## class_loader (crystal) - 1.2.0-7

The packages in the `class_loader` repository were released into the `crystal` distro by running `/home/steven/osrf/bloom/myscripts/py3env/bin/bloom-release -dr crystal class_loader --override-release-repository-url git@github.com:nuclearsandwich/class_loader-release` on `Wed, 10 Apr 2019 17:05:58 -0000`
...
## class_loader (crystal) - 1.2.0-4

The packages in the `class_loader` repository were released into the `crystal` distro by running `/home/steven/osrf/venv.bloom/bin/bloom-release -d -r crystal class_loader --override-release-repository-url git@github.com:nuclearsandwich/class_loader-release` on `Fri, 01 Mar 2019 19:47:46 -0000`
